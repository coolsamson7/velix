...
void registerEditorTypes() {
  ...
  type<User>(
    location: 'package:velix_editor/property_panel/editor/code_editor.dart:14:1',
    params: [
    ...
    methods: [
      method<User,String>('hello',
        ...
        invoker: (List<dynamic> args)=> (args[0] as User).hello()
      )
    ],
  );

  type<Page>(
    location: 'package:velix_editor/property_panel/editor/code_editor.dart:34:1',
    annotations: [
      Injectable()
    ],
    constructor: () => Page(),
  ...
  type<CodeEditorBuilder>(
    location: 'package:velix_editor/property_panel/editor/code_editor.dart:58:1',
    superClass: propertyEditorBuilderDescriptor,
    annotations: [
      Injectable()
    ],
  ...
  type<ButtonEditWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/button_widget.dart:30:1',
    superClass: widgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
