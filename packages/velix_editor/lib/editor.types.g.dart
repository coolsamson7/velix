...
void registerEditorTypes() {
  ...
  type<WidgetValidator>(
    location: 'package:velix_editor/validate/validate.dart:147:1',
    annotations: [
      Injectable()
    ],
    params: [
  ...
  type<ButtonEditWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/button_widget.dart:70:1',
    superClass: widgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
  ...
  type<ValuePropertyValidator>(
    location: 'package:velix_editor/validate/validate.dart:106:1',
    superClass: propertyValidatorDescriptor,
    annotations: [
      Injectable()
    ],
