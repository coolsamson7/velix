...
void registerEditorTypes() {
  ...
  var widgetDataDescriptor =  type<WidgetData>(
    location: 'package:velix_editor/metadata/widget_data.dart:27:1',
    annotations: [
  ...
  var abstractEnumBuilderDescriptor =  type<AbstractEnumBuilder>(
    ...
    params: [
      param<List<Enum>>('values', isNamed: true, isNullable: true, defaultValue: const [])
    ],
    constructor: ({List<Enum> values = const []}) => AbstractEnumBuilder(values: values),
    fromMapConstructor: (Map<String,dynamic> args) => AbstractEnumBuilder(values: args['values'] as List<Enum>? ?? const []),
    fromArrayConstructor: (List<dynamic> args) => AbstractEnumBuilder(values: args[0] as List<Enum>? ?? const []),
    methods: [
