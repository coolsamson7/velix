...
import 'package:velix_editor/theme/abstract_widget.dart' show AbstractEditorWidgetState;
  ...
  var widgetDataDescriptor =  type<WidgetData>(
    ...
    fields: [
      ...
      field<WidgetData,List<WidgetData>>('children',
        type: ListType<List<WidgetData>>(elementType: ObjectType<WidgetData>()),
        annotations: [
  ...
  type<ColumnWidgetData>(
    ...
    fields: [
      field<ColumnWidgetData,MainAxisAlignment>('mainAxisAlignment',
        type: ClassType<MainAxisAlignment>(),
        annotations: [
          DeclareProperty(group: "layout")
        ],
      ...
      field<ColumnWidgetData,CrossAxisAlignment>('crossAxisAlignment',
        type: ClassType<CrossAxisAlignment>(),
        annotations: [
          DeclareProperty(group: "layout")
        ],
  ...
  type<GridWidgetData>(
    ...
    fields: [
      field<GridWidgetData,List<GridItem>>('rows',
        type: ListType<List<GridItem>>(elementType: ObjectType<GridItem>()),
        annotations: [
          DeclareProperty(group: "layout")
        ],
