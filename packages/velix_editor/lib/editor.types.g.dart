...
void registerEditorTypes() {
  ...
  type<TypeRegistry>(
    location: 'package:velix_editor/metadata/type_registry.dart:8:1',
    annotations: [
      Injectable()
    ],
  ...
  type<Theme>(
    ...
    constructor: () => Theme(),
    fromMapConstructor: (Map<String,dynamic> args) => Theme(),
    fromArrayConstructor: (List<dynamic> args) => Theme(),
  );
  ...
  var WidgetBuilderDescriptor =  type<WidgetBuilder>(
    ...
    methods: [
      method<WidgetBuilder,void>('setThema',
        ...
        parameters: [
          param<Theme>('theme', isRequired: true)
        ],
  ...
  type<ButtonWidgetData>(
    location: 'package:velix_editor/metadata/widgets/button.dart:7:1',
  ...
  type<ContainerWidgetData>(
    location: 'package:velix_editor/metadata/widgets/container.dart:8:1',
    superClass: WidgetDataDescriptor,
    annotations: [
  ...
  type<TextWidgetData>(
    location: 'package:velix_editor/metadata/widgets/text.dart:7:1',
    superClass: WidgetDataDescriptor,
    annotations: [
  ...
  type<ButtonWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/button-widget.dart:7:1',
  ...
  type<ButtonEditWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/button-widget.dart:20:1',
    superClass: WidgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
  ...
  type<ContainerEditWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/container-widget.dart:10:1',
    superClass: WidgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
  ...
  type<ContainerWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/container-widget.dart:86:1',
    superClass: WidgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
  ...
  type<TextWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/text-widget.dart:7:1',
    superClass: WidgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
  ...
  type<TextEditWidgetBuilder>(
    location: 'package:velix_editor/theme/widgets/text-widget.dart:23:1',
    superClass: WidgetBuilderDescriptor,
    annotations: [
      Injectable()
    ],
