...
import 'package:flutter/material.dart' show Icons, FontWeight, FontStyle;
...
void registerEditorTypes() {
  ...
  type<Font>(
    location: 'package:velix_editor/metadata/widgets/button.dart:37:1',
    params: [
  ...
  type<ButtonWidgetData>(
    location: 'package:velix_editor/metadata/widgets/button.dart:53:1',
    superClass: widgetDataDescriptor,
    annotations: [
    ...
    fromArrayConstructor: (List<dynamic> args) => ButtonWidgetData(type: args[0] as String? ?? "button", children: args[1] as List<WidgetData>? ?? const [], label: args[2] as String? ?? '', font: args[3] as Font),
    fields: [
