...
void registerTypes() {
  type<Address>(
    location: 'asset:velix_editor/test/action_test.dart:23:1',
    params: [
  ...
  type<Page>(
    location: 'asset:velix_editor/test/action_test.dart:67:1',
    annotations: [
      Injectable()
    ],
    constructor: () => Page(),
  ...
  type<TestModule>(
    location: 'asset:velix_editor/test/action_test.dart:92:1',
    annotations: [
  ...
  type<User>(
    location: 'asset:velix_editor/test/action_test.dart:44:1',
    params: [
