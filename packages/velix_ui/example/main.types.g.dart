...
void registerAllDescriptors() {
  type<Invoice>(
    location: 'asset:velix_ui/example/main.dart:23:1',
    params: [
  ...
  var MoneyDescriptor =  type<Money>(
    location: 'asset:velix_ui/example/main.dart:31:1',
    params: [
  ...
  var StatusDescriptor =  enumeration<Status>(
    name: 'asset:velix_ui/example/main.dart.Status',
    values: Status.values
  );

  type<Product>(
    location: 'asset:velix_ui/example/main.dart:14:1',
    params: [
  ...
  var ImmutableProductDescriptor =  type<ImmutableProduct>(
    location: 'asset:velix_ui/example/main.dart:44:1',
    params: [
      param<String>('name', isNamed: true, isRequired: true), 
      param<Money>('price', isNamed: true, isRequired: true), 
      param<Status>('status', isNamed: true, isRequired: true)
  ...
  type<ImmutableRoot>(
    location: 'asset:velix_ui/example/main.dart:53:1',
    params: [
